...
export default function ShowCounter({ targetDate = "2023-12-15" }) {
    ...
    return (
        <Flex minHeight="100vh" backgroundColor="base" justifyContent="center" alignItems="center" >
            <VStack
                spacing={0}
                width="full"
                color="white"
            ...
            >
                <HStack spacing={0} gridGap={['20px', '20px', '20px', '120px']} flexWrap="wrap" justifyContent="center" >
