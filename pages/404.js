...
export default function Custom404() {
    ...
    return (
        <>
            ...
            <Flex backgroundColor="base" width="full" minHeight="100vh" justifyContent="center" alignItems="center" color="white">
                <Stack
                    padding={['30px 40px 28px', '30px 120px 60px', '30px 120px 60px', '44px 80px 60px', '94px 80px 100px']}
                    width="full" marginInline={['0px', '0px', '116px', '116px', '116px']}
                ...
                >
                    ...
                    >
                        ...
                        <Stack
                            ...
                            borderInlineStart={['none', 'none', 'none',
